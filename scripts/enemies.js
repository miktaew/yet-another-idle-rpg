...
(function(){
    enemy_templates["Starving wolf rat"] = new Enemy({
        ...
        xp_value: 1, 
        stats: {health: 20, attack: 4, agility: 8, dexterity: 6, magic: 0, intuition: 4, attack_speed: 0.8, defense: 2}, 
        loot_list: [
    ...
    enemy_templates["Wolf rat"] = new Enemy({
        ...
        xp_value: 1, 
        stats: {health: 30, attack: 6, agility: 10, dexterity: 8, intuition: 6, magic: 0, attack_speed: 1, defense: 2}, 
        loot_list: [
            {item_name: "Rat tail", chance: 0.02},
            {item_name: "Rat fang", chance: 0.02},
            {item_name: "Rat pelt", chance: 0.01},
