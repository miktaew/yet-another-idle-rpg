...
enemy_templates["Starving wolf rat"] = new Enemy({
    ...
    xp_value: 1, 
    stats: {health: 12, strength: 1, agility: 4, dexterity: 3, magic: 0, attack_speed: 0.9, defense: 0}, 
    loot_list: [
...
enemy_templates["Wolf rat"] = new Enemy({
    ...
    xp_value: 1, 
    stats: {health: 15, strength: 2, agility: 5, dexterity: 3, magic: 0, attack_speed: 1.2, defense: 0}, 
    loot_list: [
        {item_name: "Rat tail", chance: 0.1},
        {item_name: "Rat fang", chance: 0.1},
        {item_name: "Rat pelt", chance: 0.1},
...
enemy_templates["Starving wolf"] = new Enemy({
    ...
    xp_value: 3, 
    stats: {health: 25, strength: 5, agility: 7, dexterity: 5, magic: 0, attack_speed: 0.8, defense: 2}, 
    loot_list: [
...
enemy_templates["Young wolf"] = new Enemy({
    ...
    xp_value: 3, 
    stats: {health: 20, strength: 7, agility: 9, dexterity: 7, magic: 0, attack_speed: 1.1, defense: 0}, 
    loot_list: [
...
enemy_templates["Wolf"] = new Enemy({
    ...
    xp_value: 5, 
    stats: {health: 25, strength: 10, agility: 10, dexterity: 10, magic: 0, attack_speed: 1, defense: 2}, 
    loot_list: [
